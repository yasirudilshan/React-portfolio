...
function ContactSection() {
  return (
    <div>
      ...
      <text className='Sub-heading'>Ways To Contact Me</text>
      <div className='contact-items'>
          <div className='contact-email'><HiOutlineMailOpen className='icon'/> <div className='name'>Email</div><div className='link'>Dilshan.yd4c7@gmail.com</div></div>
